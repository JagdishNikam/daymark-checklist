const paths = {
  ...
  statusComplete:'<circle cx="12" cy="12" r="9"/><path d="m8 12 2.6 2.7L16.5 9"/>',
  statusIncomplete:'<circle cx="12" cy="12" r="8.5"/><path d="m8.5 8.5 7 7m0-7-7 7"/>',
  statusNA:'<circle cx="12" cy="12" r="8.5"/><path d="m6 18 12-12"/>',
  ...
  hair:'<path d="M7 20v-5a5 5 0 0 1 10 0v5M6 9c0-4 2.5-6 6-6s6 2 6 6c-2-2-4-3-6-3S8 7 6 9Z"/><path d="M9 11c1-1 2-1.5 3-1.5s2 .5 3 1.5"/>',
