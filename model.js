...
export const DEFAULT_HABITS = [
  ...
  { id:"black-coffee", name:"Black coffee", category:"morning", icon:"coffee", schedule:[1,2,3,4,5,6], time:"07:15", points:3, type:"boolean", active:true },
  ...
  { id:"avla-drink", name:"Aavla Juice", category:"nutrition", icon:"leaf", schedule:[1,2,3,4,5,6], time:"11:00", points:4, type:"boolean", active:true },
  ...
  { id:"water-intake-1", name:"Water Intake", category:"nutrition", icon:"drop", schedule:[0,1,2,3,4,5,6], time:"12:00", points:3, type:"boolean", active:true },
  ...
  { id:"dev-puja", name:"Dev Puja", category:"spiritual", icon:"spark", schedule:[1,2,3,4,5,6], time:"18:00", points:6, type:"boolean", active:true },
